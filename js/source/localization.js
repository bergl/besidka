...
var localisation = {
    ...
    'ceramics_mariz': 'KERAMIKA MAŘÍŽ',
		'besidka_text' : '\
	        ...
	        'besidka_acco_text' : '<p style="color:red">Novinka !!!!! Od 1.7. v nabídce nové pokoje v divadelním křídle.</p>\
	    ...
	    'prezident_desc' :  "<a>PREZIDENTSKÉ APARTMÁ FERDINANDA VAŇKA</a><br/>Ferdinand Vaněk přikuluje prezidentské ambice pod rokokovým štukem, zatím co Karel Brynda nechává „Život před sebou„ Sklepovským  „Mlýnům„. To vše v největším pokoji zvícím téměř 100 metrů čtverečných<br/>",
	    'vivienne_desc' :  "<a>PANÍ HATFIELDOVÁ</a><br/><br/>Filmová diva mazaného Phila Marhoula ve svém budoáru, který ráda přepouští náročným návštěvníkům prahnoucím po odlesku stříbrného plátna v dlažbě náměstí dole.",
	    'starsiosklivejsi_desc' :  "<a>STARŠÍ OŠKLIVĚJŠÍ</a><br/><br/>Ač stará a ošklivá, přesto větší a bohatší, vždy překvapující a již do Dolního náměstí hledící pokoj, málem poštovní svým sousedstvím.",
	    'mladsihezci_desc' :  "<a>MLADŠÍ HEZČÍ</a><br/><br/>Menší a mladší, dvorně výklenkovitý s největší koupelnou a levitující postelí. Kde čekání na zvanou návštěvu šlo by krátit si s kamencem, který však již není v nabídce (srozumitelné pouze pro pamětníky výstupů Ondřeje Trojana v divadle Sklep).",
	    'trossketos_desc' :  "<a>TROS SKETOS</a><br/><br/>Tři okna pro tři skety, leč jen dvě postele s výhledem do náměstí. Velikostí skoro největší s prostorem pro volný sket a noclehem na přistýlce pro třetí sketu.",
    ...
    'ceramics_mariz': 'CERAMIC MAŘÍŽ',
	    ...
	    'besidka_acco_text' : '<p style="color:red">News !!!!! Starting July 1 we offer 5 new rooms in the theater wing.</p>\
	    ...
	    'prezident_desc' :  "<a>FERDINAND VANĚK'S PRESIDENTIAL SUITE</a><br/><br/>Ferdinand Vaňek’s Presidential Suite. Ferdinand Vaňek rests with his presidential ambitions under the graceful rococco stucco, while Karel Brynda leaves  „Life Ahead“  for theatre Sklep’s „Mills“. All of this, and more, in our largest room with almost 100 square meters of presidential grace. ",
	    'vivienne_desc' :  "<a>MRS. HATFIELDOVÁ</a><br/><br/>Smart Phil Marhoul‘s film diva in her boudoir, which she happily shares with demanding visitors, who covet the mirage of the silver screen reflected in the cobblestones under the windows. ",
	    'starsiosklivejsi_desc' :  "<a>STARŠÍ OŠKLIVĚJŠÍ</a><br/><br/>Older – uglier. Although old and ugly, she’s wealthier, larger and always surprising. She sports a view of the town square and sit sbeside the post-office. ",
	    ...
	    'trossketos_desc' :  "<a>TROS SKETOS</a><br/><br/>Three windows for three skat singers, but only with two beds and a view of the town square. In size, ‘tis almost the largest – with space for some free singing and an extra bed for the third ‚singer‘. ",
