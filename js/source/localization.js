...
var localisation = {
    ...
    'ceramics_mariz': 'CERAMIC MAŘÍŽ',
		...
		'besidka_history_post': '\
            ...
            <p>It was not an easy job, though, because the house already had a life of its own that had to be maintained, yet taken to a higher level at the same time. Today, the original bar with Kryštof Trubáček’s painted tiles stands next to Martin Ceplecha’s ventilating sniffer. In the restaurant itself, though, a visitor sees no substantial changes. This, however, does not apply to the rest of the house. The accommodation is three star, yet it is an esthetic and spiritual experience rather than an anonymous overnight stay. The rooms are not numbered. They carry the names of the original eight owners who are present not in name only. You find their soul in each room. In the back of the courtyard, at the place where the idea of Maříž ceramics was born, is a ceramics studio where you can paint your own mug or a vase. In the large hall with Rococo stucco on the second floor, you can have a lecture, a workshop, or a yoga class, or rehearse a play. The visitors can judge for themselves whether the original spirit of Besídka is still alive, and how true are the words of the legendary song "The Sklep Besídka Starting, always the same, yet different each time".</p>\
		',
