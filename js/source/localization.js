...
var localisation = {
	'cs' : {
        ...
        'overall_link' : 'CELKOVÝ PŘEHLED REZERVACÍ',
		'contact' : 'KONTAKT',
		'close' : 'ZAVŘÍT',
    ...
    'ceramics_mariz': 'KERAMIKA MAŘÍŽ',
		'besidka_text' : '\
			<p>„Besídka„ je místem setkání, restaurací, hotelem, klubem i kavárnou, ale i místem odpočinku a inspirace, domovem , zázemím i zdrojem energie.</p>\
                        ...
                        <p>Citát z dob kdy „Besídka“ byla jen divadelně literární formou, než se zhmotnila do podoby domu s restaurací a barem coby hlavou, břišní kuchyní a jaterně-ledvinovým sklepem a srdcem v renesančním sále, který není vůbec renesanční a na víc v něm teď prezidentuje Ferdinand Vaněk.</p>',
	        'besidka_acco_text' : '<p style="color:red">Novinka !!!!! Od 1.7. v nabídce nové pokoje v divadelním křídle. Rezervace je možná už dnes .</p>\
                        <p>Ubytování v Besídce poskytuje radost nám ubytovatelům a věříme, že stejně se budete cítit i vy, ubytovaní.</p>\
                        <p>Nabízíme osmnáct unikátních pokojů pojmenovaných po patronech, spoluzakladatelích Besídky, lidech bez nichž by nebyla tím, čím je, ale i dle sklepovských divadelních hrdinech v nejnověji otevřeném divadelním křídle.</p>\
                        <p>Základní cena je vždy pro dvě osoby se snídaní.</p>\
                        <p>Pokoje jsou pro vás připraveny nejpozději ve 14.00, a prosíme o jejich uvolnění do 11.00 v den odjezdu. Všechny pokoje jsou nekuřácké.</p>',
                'gift_certificate_text': '<p>Chcete obdarovat své blízké a přátele?</p>\
                        <p>Připravili jsme pro vás dárkový poukaz, který je příležitostí vybrat přesně to, co potřebujete.</p>\
                        <p>Je jen na vás, zda to bude večeře, pobyt v hotelu, keramika či vše dohromady.</p>\
                        <p>Pokud budeme schopni splníme vaše přání. Napište nám nebo zavolejte.</p>\
                        <p>besidka@besidka.cz</p>\
                        <p>+420 606 212 070</p>',
		'bohac_desc' :  "<a>PAN BOHÁČ</a><br/><br/>Mezi gotickými stěnami v nejstarší části, v šedi i barvě vitrážových skel. Dvojlůžkový s čtyřmi možnými přistýlkami. Na barokním stropě odlesky řádění ohňového mužíka v původních kachlových kamnech. Místo černé kuchyně černá koupelna a v bílé vaně jsou nad hlavou už jenom hvězdy.",
	    ...
	    'vavra_desc' :  "<a>PAN VÁVRA</a><br/><br/>Dvoulůžkový pokoj s až čtyřmi přistýlkami. Noemova archa s jedinečným výhledem do náměstí. Jeden z největších pokojů v domě s jihojihozápadní orientací a dlouhými večerními paprsky slunce. Koupelna vymalovaná vlastnoručně Davidem Vávrou.",
	    ...
	    'petka_desc' :  "<a>PĚTKA</a><br/><br/>Myšlena ta pražská, kde ze Sklepa Vpřed se v Křeči Mimóza na Kolotoči netočí. Zato v nejmenším pokoji kam se určitě pět lidí nevejde, ale čtyři jo. Omluvte dočasné pracovní foto. Pokoje budou připraveny k bydlení od 1.7. 2020.</p> ",
	    ...
	    'vivienne_desc' :  "<a>PANÍ HATFIELDOVÁ</a><br/><br/>Filmová diva mazaného Phila Marhoula ve svém budoáru, který ráda přepouští náročným návštěvníkům prahnoucím po odlesku stříbrného plátna v dlažbě náměstí dole. <p>Omluvte dočasné pracovní foto. Pokoje budou připraveny k bydlení od 1.7. 2020.</p>",
	    'starsiosklivejsi_desc' :  "<a>STARŠÍ OŠKLIVĚJŠÍ</a><br/><br/>Ač stará a ošklivá, přesto větší a bohatší, vždy překvapující a již do Dolního náměstí hledící pokoj, málem poštovní svým sousedstvím. <p>Omluvte dočasné pracovní foto. Pokoje budou připraveny k bydlení od 1.7. 2020.</p>",
	    'mladsihezci_desc' :  "<a>MLADŠÍ HEZČÍ</a><br/><br/>Menší a mladší, dvorně výklenkovitý s největší koupelnou a levitující postelí. Kde čekání na zvanou návštěvu šlo by krátit si s kamencem, který však již není v nabídce (srozumitelné pouze pro pamětníky výstupů Ondřeje Trojana v divadle Sklep). <p>Omluvte dočasné pracovní foto. Pokoje budou připraveny k bydlení od 1.7. 2020.</p>",
	    'trossketos_desc' :  "<a>TROS SKETOS</a><br/><br/>Tři okna pro tři skety, leč jen dvě postele s výhledem do náměstí. Velikostí skoro největší s prostorem pro volný sket a noclehem na přistýlce pro třetí sketu. <p>Omluvte dočasné pracovní foto. Pokoje budou připraveny k bydlení od 1.7. 2020.</p>",
	    ...
	    'approx_price': 'Přibližná cena (beze slev/služeb):',
	...
	'en' : {
        ...
        'overall_link' : 'RESERVATION OVERVIEW',
		'contact' : 'CONTACT',
		'close' : 'CLOSE',
    ...
    'ceramics_mariz': 'CERAMIC MAŘÍŽ',
		'besidka_text' : '\
                    <p>Besídka is a meeting place, restaurant, hotel, club and a café but also a place to rest, get inspired, it is a home, sanctuary and a source of energy.</p>\
                    <p>This house was bought on 27 June 1988 by the so called ‚magnificent seven‘ from theatre Sklep and our friends dubbed the ‚mother of the nations‘. In 1988 the totalitarian régime in this country was still so deep we could barely see the tips of our noses and the furthest we’ve travelled was our pantry.</p>\
                    <p>Quote from the times when Besidka existed purely as a theatrical concept, before it materialised into its current form – the restaurant and bar functioning as the metaphorical head, the kitchen as a stomach, the cellar as a liver-focused pit stop and the heart of it all in the renaissance hall (which is not even really from the Renaissance) and is now presided over by Ferdinand Vaněk.</p>',
	    'besidka_acco_text' : '<p style="color:red">News !!!!! Starting July 1 we offer 5 new rooms in the theater wing. Reservations are possible today.</p>\
                    <p>The accommodation in Besidka provides us with great joy and we believe that you, our guests, will feel the same.</p>\
                    <p>You can choose from eighteen unique rooms named after our patrons, co-founders and people without whom Besidka would not be what it is but also after heroes of theatre Sklep\’s plays in our newest ‚theatre wing‘.</p>\
                    <p<Our rooms will be prepared for you at 14:00 at the latest. We would be very greateful if you could vacate your room by 11:00 on your departure date, so we can prepare the room for our next visitors. All rooms are non-smoking only.</p>',
	    'gift_certificate_text': "<p>Are you looking for a memorable gift for friends or family?</p>\
                    <p>Our gift voucher can be just what you were looking for. It’s up to you to pick what the voucher will cover – a festive dinner, a few nights in a boutique hotel, hand-made original ceramics or perhaps all of the above? You can select the gift voucher to cover whatever amount or combination of items you want.\
                    We will endeavour to fulfill your wish and provide your friends and family with an unforgettable experience.\
                    Please contact us on besidka@besidka.cz or call +420 606 212 070 to find out more, or to order your gift voucher now.<p>",
            'bohac_desc' :  "<a>MR. BOHÁČ</a><br/><br/>The suite among the Gothic walls of the oldest part of the house, in grey and colour of the vitrage glass. Double room, option of four extra beds. Watch the fire sprite\’s fury in the original tile stove reflect on the Baroque ceiling. The original black kitchen was turned into a black bathroom. Watch the stars from your white bathtub.",
	    ...
	    'vavra_desc' :  "<a>MR. VÁVRA</a><br/><br/>A double room with up to four extra beds. A Noah’s Ark upside down, with a unique view of the square. One of the largest rooms in the house, facing south-south-west, catching the long evening sunrays. David Vávra painted the bathroom himself.",
	    ...
	    'petka_desc' :  "<a>PĚTKA</a><br/><br/>The Five. Meaning the theatres called the ‚Prague Five‘ - where from the Cellar (Sklep) in the Front (Vpřed) in a Cramp (Křeč) Mimosa (Mimóza) is not on a Merry-go-round (Kolotoč). Though the smallest room will not house all five, there is ample space for four occupants. <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020. ",
	    'prezident_desc' :  "<a>MR. VANĚK</a><br/><br/>Ferdinand Vaňek’s Presidential Suite. Ferdinand Vaňek rests with his presidential ambitions under the graceful rococco stucco, while Karel Brynda leaves  „Life Ahead“  for theatre Sklep’s „Mills“. All of this, and more, in our largest room with almost 100 square meters of presidential grace.  <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020.</p> ",
	    'vivienne_desc' :  "<a>MRS. HATFIELDOVÁ</a><br/><br/>Smart Phil Marhoul‘s film diva in her boudoir, which she happily shares with demanding visitors, who covet the mirage of the silver screen reflected in the cobblestones under the windows.  <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020.</p> ",
	    'starsiosklivejsi_desc' :  "<a>STARŠÍ OŠKLIVĚJŠÍ</a><br/><br/>Older – uglier. Although old and ugly, she’s wealthier, larger and always surprising. She sports a view of the town square and sit sbeside the post-office.  <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020.</p> ",
	    'mladsihezci_desc' :  "<a>MLADŠÍ HEZČÍ</a><br/><br/>Younger - prettier. Smaller and younger, with a courteous alcove, the largest bathroom and a levitating bed. Here, one could pass time waiting for invitees with potassium alum, however that is not on offer (comprehensible only for those privy to Ondřej Trojan’s performances in theatre Sklep).  <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020.</p> ",
	    'trossketos_desc' :  "<a>TROS SKETOS</a><br/><br/>Three windows for three skat singers, but only with two beds and a view of the town square. In size, ‘tis almost the largest – with space for some free singing and an extra bed for the third ‚singer‘.  <p>Excuse the temporary photo of unfinished room. Rooms will be ready by July 7 2020.</p> ",
	    ...
	    'approx_price': 'Approx. price (without discounts/services):',
	    'person_count' : 'Person #:',
		'name' : 'First name:',
		'fname' : 'Family name:',
		'mail' : 'Email:',
