...
var localisation = {
    ...
    'ceramics_mariz': 'KERAMIKA MAŘÍŽ',
		'besidka_text' : '\
	        ...
	        'besidka_acco_text' : '<p>Ubytování v Besídce poskytuje radost nám ubytovatelům a věříme, že stejně se budete cítit i vy, ubytovaní.</p>\
	    ...
	    'petka_desc' :  "<a>PĚTKA</a><br/><br/>Myšlena ta pražská, kde ze Sklepa Vpřed se v Křeči Mimóza na Kolotoči netočí. Zato v nejmenším pokoji kam se určitě pět lidí nevejde, ale čtyři jo.",
    ...
    'ceramics_mariz': 'CERAMIC MAŘÍŽ',
	    ...
	    'besidka_acco_text' : '<p>The accommodation in Besidka provides us with great joy and we believe that you, our guests, will feel the same.</p>\
	    ...
	    'petka_desc' :  "<a>PĚTKA</a><br/><br/>The Five. Meaning the theatres called the ‚Prague Five‘ - where from the Cellar (Sklep) in the Front (Vpřed) in a Cramp (Křeč) Mimosa (Mimóza) is not on a Merry-go-round (Kolotoč). Though the smallest room will not house all five, there is ample space for four occupants.",
